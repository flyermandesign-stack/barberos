    ...
    <main style={{ background: '#080808', minHeight: '100vh', color: '#ede8e0', fontFamily: 'Inter, sans-serif' }}>
      ...
      <div style={{ maxWidth: '800px', margin: '0 auto', padding: '2rem' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem', marginBottom: '2.5rem' }}>
          {servicos?.map(s => (
            <div key={s.id} style={{ background: '#181818', border: '1px solid #252525', borderRadius: '10px', padding: '1rem 1.25rem', display: 'flex', alignItems: 'center', justifyContent: 'space-between', transition: 'border-color 0.15s' }}>
              <div>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
                ...
                <button style={{ padding: '0.45rem 1rem', borderRadius: '6px', border: '1px solid #b4913c', background: 'transparent', color: '#b4913c', fontSize: '0.72rem', fontWeight: 600, cursor: 'pointer', letterSpacing: '1px', textTransform: 'uppercase' }}>
                  Agendar
                </button>
              </div>
            </div>
